...
import { SuiMarketSection } from "@/components/sui-market-section";
    ...
    <MatrixPage>
      <div className="matrix-tank-shell matrix-tank-page">
        <section className="matrix-tank-burn-strip">
          ...
          <p>SUI COMMUNITY UPDATE: TRACK BURNS, TREASURY, AND NETWORK MOMENTUM</p>
          <a href="#" className="matrix-tank-plan-btn">View SUI Roadmap</a>
        </section>

        <section className="matrix-tank-hero">
          <div className="matrix-tank-hero-logo-wrap matrix-sui-hero-logo-wrap">
            <div className="matrix-tank-hero-logo-ring" />
            <img src="/tokens/sui-logo.png" alt="SUI Logo" className="matrix-tank-hero-logo matrix-sui-hero-logo" />
          </div>
          <h1 className="matrix-tank-title">SUI</h1>
          <h2 className="matrix-tank-symbol">$SUI</h2>
          <p className="matrix-tank-tagline">Move-based blockchain for speed, scale, and ownership</p>
          ...
          <div className="matrix-tank-cta-row">
            ...
            <a href="#" className="matrix-tank-cta-secondary"><i className="fas fa-share-nodes" /> Share $SUI</a>
          </div>
        </section>

        <section className="matrix-tank-burn-metrics">
          <article className="matrix-tank-burn-card">
            <div className="matrix-tank-burn-label">Total SUI Burned</div>
            <div className="matrix-tank-burn-value">0 SUI</div>
            <div className="matrix-tank-burn-foot">
              Verify on SuiScan <i className="fas fa-external-link-alt" />
            </div>
          </article>
          <article className="matrix-tank-burn-card">
            <div className="matrix-tank-burn-label">Treasury Balance</div>
            <div className="matrix-tank-burn-value">22,05,81,644 SUI</div>
        ...
        <section className="matrix-tank-micro-stats">
          ...
          <article className="matrix-tank-mini-card">
            ...
            <div className="matrix-tank-mini-value">Sui</div>
          </article>
          <article className="matrix-tank-mini-card">
            <div className="matrix-tank-mini-icon">📈</div>
            <div className="matrix-tank-mini-label">Target Milestone</div>
            <div className="matrix-tank-mini-value">18M SUI</div>
          </article>
        </section>
        ...
        <section className="matrix-tank-contract">
          ...
          <a href="#" className="matrix-tank-contract-link">
            View on SuiScan <i className="fas fa-external-link-alt" />
          </a>
        </section>
        ...
        <section className="matrix-tank-story">
          <article className="matrix-tank-info-card matrix-tank-info-single">
            <h2>About SUI</h2>
            <p>
              SUI ($SUI) is a next-generation Layer-1 blockchain focused on low-latency transactions, horizontal scalability, and a smooth developer experience powered by Move.
            </p>
          </article>
          <article className="matrix-tank-info-card matrix-tank-info-single">
            <h2>Our Vision</h2>
            <p>
              FUSION MATRIX supports open participation in the Sui ecosystem through education, community growth, and transparent on-chain experiences built for long-term value.
            </p>
          </article>
        </section>
        ...
        <section className="matrix-tank-how-buy">
          ...
          <div className="matrix-tank-how-grid">
            <article className="matrix-tank-step-card">
              ...
              <h3>Choose a Sui Wallet</h3>
              <p>Create or import a wallet, then fund it to begin transacting on the Sui network.</p>
              <a href="#">Get a Sui Wallet <i className="fas fa-arrow-right" /></a>
            </article>
            <article className="matrix-tank-step-card">
              <div className="matrix-tank-step-num">2</div>
              <h3>Trade on a Sui DEX</h3>
              <p>Swap into $SUI using a Sui-native DEX and verify all activity on-chain through SuiScan.</p>
              <a href="#">Trade on Sui DEX <i className="fas fa-arrow-right" /></a>
            </article>
          </div>
        </section>
        ...
        <section className="matrix-tank-wallets">
          ...
          <p className="matrix-tank-wallet-note">Always verify network details and contract information before trading $SUI.</p>
        </section>
      </div>

      <a href="#" className="matrix-tank-sticky-plan-btn">
        <i className="fas fa-fire" />
        <span>View SUI Roadmap</span>
      </a>
    </MatrixPage>
  );
}
